...
import com.example.upkeep.activity_tenant.SubmitMaintaineanceActivity;
...
public class RepairTenantFragment extends Fragment {
    private Activity activity;
    private ProgressBar progressBar;
    private TextView tvNoRepairFound;
    private FloatingActionButton floatingActionButton;
    private RecyclerView recyclerView;
    public RepairTenantFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_repair_tenant, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(activity, SubmitMaintaineanceActivity.class);
