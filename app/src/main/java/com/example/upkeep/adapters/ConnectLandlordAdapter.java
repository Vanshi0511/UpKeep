...
public class ConnectLandlordAdapter extends RecyclerView.Adapter<ConnectLandlordAdapter.ViewHolder> {

    private Context context;
    private Activity activity;

    public ConnectLandlordAdapter(Context context,Activity activity )
    {
